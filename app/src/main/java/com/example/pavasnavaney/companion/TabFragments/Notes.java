...
public class Notes extends Fragment {
    ...
    public Notes(String subject , String semester , String course)
    {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Background_Notes back = new Background_Notes(getActivity());
        back.execute();
    }
    ...
    public class Background_Notes extends AsyncTask<String,Void,String>
    {
...
SweetAlertDialog sweetAlertDialog;
        ...
        public Background_Notes(Context ctx)
        {
            this.ctx=ctx;
        }
        ...
        protected String doInBackground(String... strings) {
            ...
            String course_get_url = ur.notes;
            try {
