...
public class Books extends Fragment {
    ...
    private String subject,semester,course;
    ...
    public Books(String subject , String semester , String course)
    {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Background_Books back = new Background_Books(getActivity());
        back.execute();
    }
    ...
    public class Background_Books extends AsyncTask<String,Void,String>
    {
        String final_res;
        String json_string;
        Context ctx;
        ...
        public Background_Books(Context ctx)
        {
            this.ctx=ctx;
        }
        ...
        protected void onPreExecute() {
            ...
            sweetAlertDialog.setTitleText("Loading Books...");
        ...
        protected String doInBackground(String... strings) {
            ...
            String course_get_url = ur.books;
            try {
