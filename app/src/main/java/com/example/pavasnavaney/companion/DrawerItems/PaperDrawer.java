...
import com.example.pavasnavaney.companion.TabFragments.ListAdapterForPapers;
import com.example.pavasnavaney.companion.TabFragments.PaperList;
 ...
 */
public class PaperDrawer extends Fragment {
    ...
    public PaperDrawer(String subject,String department)
    {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Background_PapersDrawer back = new Background_PapersDrawer(getActivity());
        back.execute();
    }
    ...
    public class Background_PapersDrawer extends AsyncTask<String,Void,String>
    {
        String final_res;
        String json_string;
        Context ctx;
        ...
        public Background_PapersDrawer(Context ctx)
        {
            this.ctx=ctx;
        }
        ...
        protected String doInBackground(String... strings) {
            ...
            String course_get_url = ur.papersdrawer;
            try {
