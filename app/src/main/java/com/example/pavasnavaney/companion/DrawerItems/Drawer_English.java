...
public class Drawer_English extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_drawer__english);
        ...
        Background_English back = new Background_English(Drawer_English.this);
        back.execute();
    ...
    public class Background_English extends AsyncTask<String,Void,String>
    {
        ...
        public Background_English(Context ctx)
        {
            this.ctx = ctx;
        }
        ...
        protected String doInBackground(String... strings) {
            ...
            String course_get_url = ur.english;
            try {
        ...
        protected void onPostExecute(String result) {
            ...
            try {
                ...
                while (count < jsonArray.length()) {
                    ...
                    deptlist.add(map);
                    adapter = new ListAdapterForEnglish(Drawer_English.this,deptlist);
