 ...
 */
public class ListAdapterForEnglish extends BaseAdapter {
    ...
    public ListAdapterForEnglish(Context context, List<Dept_Loader> deptlist) {
    ...
    public View getView(final int position, View view, ViewGroup parent) {
        ...
        if (view == null) {
            ...
            view = inflater.inflate(R.layout.english_list_item, null);
